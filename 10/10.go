...
// Дано дерево комментариев, состоящее из комментариев и ответов на них.
// Каждый комментарий имеет уникальный идентификатор и может иметь родительский комментарий.
// Комментарий, у которого родительский комментарий не указан, является корневым.
// Напишите программу, которая выводит дерево комментариев в виде дерева
